    ...
    public void checkMenuItem(int menu_item) {
        ...
        switch (menu_item) {
            case 1:
                ...
                Integer result = task1.evaluateUsingRegex();
            ...
            case 2:
                ...
                break;
            case 3:
                String term3 = "Условие задания 3. Создайте программу, которая будет:\n" +
                ...
                break;
            case 4:
                String term4 = "Условие задания 4. Создайте программу, которая будет получать число и печатать его в следующем формате " +
...
//                String number = "0123456789";
                ...
                break;
            case 5:
                String term5 = "Условие задания 5. Есть набор предметов, задаваемый заранее, предметы могут повторяться. " +
